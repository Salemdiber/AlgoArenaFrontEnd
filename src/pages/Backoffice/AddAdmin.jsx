                    ...
                    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="role" value={formData.role} onChange={handleChange} className="form-select w-full bg-[#0f172a]">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="mt-3 bg-[#0f172a] p-4 rounded-lg border border-gray-800">
