        ...
        return (
            <div className="space-y-6 animate-pulse">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="glass-panel rounded-2xl p-6 shadow-custom h-48 border border-gray-700/50">
        ...
        <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div className="glass-panel rounded-2xl p-6 shadow-custom">
                    ...
                    <p className="text-sm text-gray-400 text-center">{healthData.cpu.cores} cores available</p>
                </div>
                ...
                <div className="glass-panel rounded-2xl p-6 shadow-custom">
                    ...
                    <p className="text-sm text-gray-400 text-center">{healthData.memory.used} GB / {healthData.memory.total} GB</p>
                </div>
                ...
                <div className="glass-panel rounded-2xl p-6 shadow-custom">
                    ...
                    <p className="text-sm text-gray-400 text-center">{healthData.disk.used} GB / {healthData.disk.total} GB</p>
                </div>
                ...
                <div className="glass-panel rounded-2xl p-6 shadow-custom">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="font-heading text-lg font-semibold text-gray-100">Background Services</h3>
