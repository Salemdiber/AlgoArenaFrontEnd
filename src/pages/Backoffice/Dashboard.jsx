...
const Dashboard = () => {
    return (
        <div className="space-y-6 animate-fade-in-up">
            {/* Page Header */}
            <div className="mb-6">
                <h1 className="font-heading text-3xl font-bold text-gray-100 mb-2">Dashboard Overview</h1>
                <p className="text-gray-400">Monitor platform performance and activity in real-time</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="glass-panel p-6 rounded-2xl shadow-custom">
                    <h2 className="font-heading text-xl font-bold text-gray-100 mb-4">Active Users (7 Days)</h2>
                    <div className="h-64 overflow-hidden">
                        <ActiveUsersChart />
                    </div>
                </div>
                <div className="glass-panel p-6 rounded-2xl shadow-custom">
                    <h2 className="font-heading text-xl font-bold text-gray-100 mb-4">Most Played Games</h2>
                    <div className="h-64 overflow-hidden">
                        <GamesChart />
                    </div>
                </div>
            ...
            <div className="glass-panel p-6 rounded-2xl shadow-custom">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="font-heading text-xl font-bold text-gray-100">AI Activity Monitor</h2>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 p-4 bg-[#0f172a] rounded-lg border border-gray-800 spotlight-hover table-row-hover group">
                        ...
                        <div className="flex-1 relative z-10">
                            <p className="text-sm font-medium text-gray-200 group-hover:text-yellow-400 transition-colors">
