  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex flex-col items-center justify-center relative overflow-hidden font-body">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple-500/10 rounded-full blur-[100px] animate-blob"></div>
      </div>

      <div className="relative z-10 glass-panel p-12 rounded-3xl border border-gray-700/50 flex flex-col items-center max-w-sm w-full shadow-2xl backdrop-blur-xl">
        ...
        <div className="relative w-24 h-24 mb-8">
          ...
          <div className="absolute inset-0 flex items-center justify-center drop-shadow-[0_0_8px_rgba(34,211,238,0.8)]">
        ...
        <h2 className="text-2xl font-heading font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 mb-2">
          Authenticating
        </h2>

        <p className="text-gray-400 text-sm font-medium text-center animate-pulse">
