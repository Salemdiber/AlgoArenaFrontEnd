...
const Sidebar = ({ isOpen = false, onClose }) => {
    return (
        <aside
            className={`
                w-64 bg-[#0b1220] border-r border-gray-800 flex flex-col h-full z-40 transition-all duration-300
                fixed top-0 left-0
        ...
        >
            ...
            <button
                className="lg:hidden absolute top-4 right-4 p-2 rounded-lg text-gray-400 hover:text-cyan-400 hover:bg-[#0f172a] transition-all z-50"
                onClick={onClose}
